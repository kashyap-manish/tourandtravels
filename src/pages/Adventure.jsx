...
const highlights = [
  { icon: 'fa-mountain', title: 'Trekking & Hiking', desc: 'Conquer breathtaking trails across the world\'s most stunning mountain ranges.' },
  { icon: 'fa-tint', title: 'White Water Rafting', desc: 'Ride the rapids through thrilling river gorges with expert guides.' },
  { icon: 'fa-bicycle', title: 'Cycling Tours', desc: 'Explore scenic routes on two wheels at your own pace.' },
  { icon: 'fa-plane', title: 'Skydiving', desc: 'Experience the ultimate adrenaline rush with tandem skydiving.' },
  { icon: 'fa-ship', title: 'Sailing', desc: 'Navigate open waters and discover hidden coastal gems.' },
  { icon: 'fa-tree', title: 'Zip Lining', desc: 'Soar through forest canopies on exhilarating zip line courses.' },
];

const tours = [
  { img: '/images/destination-1.jpg', title: 'Himalayan Trek', days: '12 Days', price: '₹1,07,999' },
  { img: '/images/destination-2.jpg', title: 'Amazon Expedition', days: '8 Days', price: '₹82,999' },
  { img: '/images/destination-3.jpg', title: 'Patagonia Adventure', days: '10 Days', price: '₹1,24,999' },
];
    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 text-center text-white pb-16 px-4">
          ...
          <h1 className="text-5xl md:text-6xl font-extrabold tracking-tight">Adventure</h1>
          <p className="mt-3 text-gray-300 text-lg max-w-xl mx-auto">Push your limits and explore the wild</p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold mt-3 text-gray-900">Adventure Experiences</h2>
          </div>
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold mt-3 text-gray-900">Adventure Tours</h2>
          </div>
