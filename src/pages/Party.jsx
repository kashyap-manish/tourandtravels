...
const highlights = [
  ...
  { icon: 'fa-glass', title: 'Nightlife Tours', desc: 'Explore the best clubs, bars, and lounges in vibrant cities.' },
  { icon: 'fa-birthday-cake', title: 'Private Events', desc: 'Celebrate birthdays and milestones in extraordinary destinations.' },
  { icon: 'fa-users', title: 'Group Parties', desc: 'Organize unforgettable group celebrations with full event support.' },
  { icon: 'fa-star', title: 'VIP Experiences', desc: 'Exclusive access to premium venues and celebrity events.' },
  { icon: 'fa-ship', title: 'Yacht Parties', desc: 'Host spectacular parties on luxury yachts in stunning waters.' },
];

const tours = [
  { img: '/images/place-1.jpg', title: 'Ibiza Party Week', days: '7 Days', price: '₹1,32,999' },
  { img: '/images/place-2.jpg', title: 'Rio Carnival', days: '5 Days', price: '₹1,07,999' },
  { img: '/images/place-3.jpg', title: 'Bangkok Nightlife', days: '6 Days', price: '₹74,999' },
];
    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 text-center text-white pb-16 px-4">
          ...
          <h1 className="text-5xl md:text-6xl font-extrabold tracking-tight">Party</h1>
          <p className="mt-3 text-gray-300 text-lg max-w-xl mx-auto">Celebrate life in the world's most exciting destinations</p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold mt-3 text-gray-900">Party Experiences</h2>
          </div>
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold mt-3 text-gray-900">Party Tours</h2>
          </div>
